export const paris = {
  ...
  outro: {
    text: "<span className='text-h3 flex items-center flex-wrap mx-auto text-(--content-primary)'>From<img loading='lazy' className='mx-2 object-contain h-[clamp(52.7px,5.4vw+35.4px,102.4px)] w-[clamp(52.7px,5.4vw+35.4px,102.4px)] aspect-square' src='https://res.cloudinary.com/dixqgrowr/image/upload/v1770581270/emily_in_paris_motion_design_exploration/images/stickers/sticker-croissant-making-workshop_wfhs3n.avif'/><span className='bg-(--bg-brand-tertiary)'>croissant-making</span>&thinsp; workshops to<img loading='lazy' className='mx-2 object-contain h-[clamp(52.7px,5.4vw+35.4px,102.4px)] w-[clamp(52.7px,5.4vw+35.4px,102.4px)] aspect-square' src='https://res.cloudinary.com/dixqgrowr/image/upload/v1770581270/emily_in_paris_motion_design_exploration/images/stickers/sticker-champagne-seine-cruise_ygrfc0.avif'/><span className='bg-(--bg-brand-secondary)'>champagne Seine cruises,</span>&thinsp;<span>discover</span><img loading='lazy' className='mx-2 object-contain h-[clamp(52.7px,5.4vw+35.4px,102.4px)] w-[clamp(52.7px,5.4vw+35.4px,102.4px)] aspect-square' src='https://res.cloudinary.com/dixqgrowr/image/upload/v1770581271/emily_in_paris_motion_design_exploration/images/stickers/sticker-montmartre-tour_c8zn5q.avif'/><span className='bg-(--bg-brand)'>secret streets</span>&thinsp;<span>and Paris moments à la Emily.</span></span>",
  },
};
